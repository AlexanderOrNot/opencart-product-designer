<?php
class ModelProductDesignerProductDesigner extends Model { 
	public function getDataByToken($token)
	{
		$query = $this->db->query('SELECT * FROM ' . DB_PREFIX . 'product_designer WHERE token="' . $token . '"');
		return $query->row;
	}
	...
	public function getProductDesignerOptions($product_id){
