...
class ControllerModuleProductDesigner extends Controller {
	public function index() {
        ...
        if (isset($this->request->post['product_designer_module'])) {
            $this->data['modules'] = $this->request->post['product_designer_module'];
        } elseif ($this->config->get('product_designer_module')) {
            $this->data['modules'] = $this->config->get('product_designer_module');
        }
